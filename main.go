...
import (
	...
	"github.com/woshashishishi/blog-service/internal/model"
...
func main() {
	err := setupDBEngine(global.DatabaseSetting)
	if err != nil {
...
func setupDBEngine(databaseSetting *setting.DatabaseSettingS) error {
	var err error
